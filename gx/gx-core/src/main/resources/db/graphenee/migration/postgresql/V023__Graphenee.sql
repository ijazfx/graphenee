CREATE SEQUENCE gx_authentication_seq;
CREATE SEQUENCE gx_entity_callback_seq;

CREATE TABLE gx_authentication (
    oid not null default nextval('gx_authentication_seq'::regclass),
...
CREATE TABLE gx_entity_callback (
    oid not null default nextval('gx_entity_callback_seq'::regclass),
    name character varying(255),
    description character varying(255),
