...
public class GxDomainForm extends GxAbstractEntityForm<GxDomain> {
    ...
    protected void decorateForm(HasComponents entityForm) {
        ...
        GxCopyToClipboardWrapper txtRecordWrapper = new GxCopyToClipboardWrapper(txtRecord);

        entityForm.add(dns, txtRecordWrapper, isVerified, isActive);
        expand(dns, txtRecordWrapper, isVerified, isActive);
    }
