...
public class MapField<K, V> extends CustomField<Map> {
	...
	static {
		ADDED_METHOD = ReflectTools.findMethod(ElementAddedListener.class, "elementAdded", ElementAddedEvent.class);
		REMOVED_METHOD = ReflectTools.findMethod(ElementRemovedListener.class, "elementRemoved", ElementRemovedEvent.class);
	}
