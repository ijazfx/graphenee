...
public class MSize implements Serializable {
	...
	public static MSize width(String width) {
		...
		return size != null ? new MSize(size.getSize(), size.getUnit(), -1, Sizeable.Unit.PIXELS) : new MSize(-1, Sizeable.Unit.PIXELS, -1, Sizeable.Unit.PIXELS);
	}
	...
	public static MSize height(String height) {
		...
		return size != null ? new MSize(-1, Sizeable.Unit.PIXELS, size.getSize(), size.getUnit()) : new MSize(-1, Sizeable.Unit.PIXELS, -1, Sizeable.Unit.PIXELS);
	}
