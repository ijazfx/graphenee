...
public class DynaBeanItem<T> implements Item {
	...
	private class DynaProperty implements Property {
		...
		public Class<?> getType() {
			try {
				final org.apache.commons.beanutils.DynaProperty dynaProperty = getDynaBean().getDynaClass().getDynaProperty(propertyName);
				...
				try {
					return org.vaadin.viritin.ListContainer.getNestedPropertyType(getDynaBean().getDynaClass(), propertyName);
	...
	public Property getItemProperty(Object id) {
		...
		if (getDynaBean().getDynaClass().getDynaProperty(propertyName) == null) {
			...
			if (!(defaultResolver.hasNested(propertyName) || defaultResolver.isIndexed(propertyName) || defaultResolver.hasNested(propertyName))) {
	...
	public Collection<String> getItemPropertyIds() {
		...
		for (org.apache.commons.beanutils.DynaProperty dp : getDynaBean().getDynaClass().getDynaProperties()) {
