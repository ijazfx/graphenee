...
public interface TaskRepository extends JpaRepository<Task, Integer> {
	...
	Page<Task> searchOwnedAndGroupTasks(@Param("entityIds")  List<String> entityIds,@Param("statuses") List<String> statuses,@Param("searchText")  String searchText, Pageable pageRequest);
