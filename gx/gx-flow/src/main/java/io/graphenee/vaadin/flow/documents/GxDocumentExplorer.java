...
public class GxDocumentExplorer extends GxAbstractEntityTreeList<GxDocumentExplorerItem> {
    ...
    public void chooseSingle(GxDocumentFilter filter, TRParamCallback<GxDocument> onChoose) {
        ...
        setWidthFull();
        setHeight("600px");
        ConfirmDialog.createQuestion().withCaption("Choose a Document").withMessage(this).withOkButton(() -> {
        ...
        }, ButtonOption.focus(), ButtonOption.caption("Choose")).withCancelButton(ButtonOption.caption("Dismiss"))
                .open();
    }
